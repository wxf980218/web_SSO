...
$(function () {
    ...
    $.get("http://localhost:8081/web_SSO/conn.php",function (data,status) {
          //data为object
          ztreeJson = data;
          darwZtree();
    });
    ...
    $.get("http://localhost:8081/web_SSO/conn2.php",function (data,status) {
        //data为object
        appraisalJson = data;
        drawData();
    });
    ...
    $('#save').unbind('click').bind('click',function () {
        $('.content,.remark').attr('disabled','disabled');
            ...
            if(year==tableYear&&month==tableMonth&&treeNodeInfo.id==tableID){
                ...
                flag1 = 1;
                $.post("http://localhost:8081/web_SSO/conn3.php",{
                    id: tableID,
                    year: tableYear,
                    month:tableMonth,
                    flag:flag1,
